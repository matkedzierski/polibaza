...
namespace PoliBaza.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        private async Task LoadAsync(IdentityUser user)
        {
            ...
            var prefs = await _db.UserPreferences.FirstOrDefaultAsync(p => p.User == user);
        ...
        public async Task<bool> UpdatePrefs(IdentityUser user)
        {
            ...
            _logger.LogWarning(Input.PrimaryColor.ToString());
            _logger.LogWarning(color.ToString());
            ...
            _logger.LogWarning(saveResult.ToString());
            if (saveResult > 0) return true;
            StatusMessage = "Nieoczekiwany błąd podczas zmiany preferencji.";
            return false;
